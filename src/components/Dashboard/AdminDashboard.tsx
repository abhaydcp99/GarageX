...
import { Users, Wrench, Calendar, DollarSign, Plus, Edit, Trash2, Eye } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage services, bookings, and monitor platform activity</p>
        </div>
