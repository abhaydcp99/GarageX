...
import { Calendar, Clock, DollarSign, MapPin, Eye, Edit, Trash2, Plus } from 'lucide-react';
...
export function CustomerDashboard() {
  ...
  const stats = {
    ...
    totalSpent: bookings.filter(b => b.status !== 'cancelled').reduce((sum, booking) => sum + booking.totalAmount, 0)
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Welcome back, {user?.name}! Manage your bookings and services here.</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          {bookings.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">Start by booking your first car service</p>
              <Link
                to="/services"
                  ...
                  {bookings.map((booking) => (
                    <tr key={booking.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {booking.bookingDate}<br/>{booking.bookingTime}
                      </td>
