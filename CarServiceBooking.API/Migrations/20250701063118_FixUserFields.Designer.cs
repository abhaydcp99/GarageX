...
namespace CarServiceBooking.API.Migrations
{
    ...
    [Migration("20250701063118_FixUserFields")]
            ...
            modelBuilder.Entity("CarServiceBooking.API.Models.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 1, 6, 31, 17, 938, DateTimeKind.Utc).AddTicks(7660),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Safety",
                            CreatedAt = new DateTime(2025, 7, 1, 6, 31, 17, 938, DateTimeKind.Utc).AddTicks(7666),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Cleaning",
                            CreatedAt = new DateTime(2025, 7, 1, 6, 31, 17, 938, DateTimeKind.Utc).AddTicks(7671),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Maintenance",
                            CreatedAt = new DateTime(2025, 7, 1, 6, 31, 17, 938, DateTimeKind.Utc).AddTicks(7704),
            ...
            modelBuilder.Entity("CarServiceBooking.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 1, 6, 31, 17, 408, DateTimeKind.Utc).AddTicks(226),
                            Email = "admin@carservice.com",
                            Name = "Admin User",
                            PasswordHash = "$2a$11$5r/aCTw1Nk.38VW49Ze1vuE6IhzvblYXEQoSbkbuv/2dcf029pIaO",
                            Phone = "+1234567890",
                            Role = "admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 7, 1, 6, 31, 17, 673, DateTimeKind.Utc).AddTicks(8864),
                            Email = "provider@carservice.com",
                            Name = "Service Provider",
                            PasswordHash = "$2a$11$Hf/Np.M3C7capwq2ygcNnu/Pkm1YFKoWsQ8iN/XTIxJojYkUYu3uS",
                            Phone = "+1234567891",
                            Role = "provider"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 1, 6, 31, 17, 938, DateTimeKind.Utc).AddTicks(6188),
                            Email = "customer@carservice.com",
                            Name = "John Customer",
                            PasswordHash = "$2a$11$fdQrM1f0aMgPdKMwtS7Da.Qo/rPBelD8QpzXEuDtSS0ciH4ZNzOZ2",
                            Phone = "+1234567892",
                            Role = "customer"
                        });
                });
