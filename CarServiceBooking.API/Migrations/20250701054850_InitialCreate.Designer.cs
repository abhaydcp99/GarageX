...
namespace CarServiceBooking.API.Migrations
{
    ...
    [Migration("20250701054850_InitialCreate")]
            ...
            modelBuilder.Entity("CarServiceBooking.API.Models.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 1, 5, 48, 49, 929, DateTimeKind.Utc).AddTicks(2989),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Safety",
                            CreatedAt = new DateTime(2025, 7, 1, 5, 48, 49, 929, DateTimeKind.Utc).AddTicks(2995),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Cleaning",
                            CreatedAt = new DateTime(2025, 7, 1, 5, 48, 49, 929, DateTimeKind.Utc).AddTicks(2998),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Maintenance",
                            CreatedAt = new DateTime(2025, 7, 1, 5, 48, 49, 929, DateTimeKind.Utc).AddTicks(3018),
            ...
            modelBuilder.Entity("CarServiceBooking.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 1, 5, 48, 49, 409, DateTimeKind.Utc).AddTicks(3426),
                            Email = "admin@carservice.com",
                            Name = "Admin User",
                            PasswordHash = "$2a$11$tHi6LP/yDi4dX7gWG3jxle9f8.oPWt/RjbjDRZlcTo10h/A82T9R.",
                            Phone = "+1234567890",
                            Role = "admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 7, 1, 5, 48, 49, 665, DateTimeKind.Utc).AddTicks(4129),
                            Email = "provider@carservice.com",
                            Name = "Service Provider",
                            PasswordHash = "$2a$11$pHEgULUFLau7ikjV2MZBkOjDJj4amQsom2EEY9/a2.s7G/8LvRBvy",
                            Phone = "+1234567891",
                            Role = "provider"
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 1, 5, 48, 49, 929, DateTimeKind.Utc).AddTicks(2029),
                            Email = "customer@carservice.com",
                            Name = "John Customer",
                            PasswordHash = "$2a$11$.aObnIQ063d2iojaDr0rmeglLdkY6cfqX13naBVErCXHxPW8gmV3i",
                            Phone = "+1234567892",
                            Role = "customer"
                        });
                });
