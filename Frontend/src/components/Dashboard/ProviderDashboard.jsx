...
export default function ProviderDashboard() {
  ...
  const getProviderServices = () =>
    DataStore.getServices().filter((s) => s.providerId === user.id);
  const getProviderBookings = () =>
    DataStore.getBookings().filter((b) => b.providerId === user.id);

  const [services, setServices] = useState(getProviderServices());
  const [bookings] = useState(getProviderBookings());
  ...
  const handleSubmitService = (e) => {
    ...
    setServices(getProviderServices());
